...
public class MaterialEvent extends ExplorationEvent {
    ...
    public void execute(Player player, PlayerService playerService,
        ...
        String[][] materials = {
            {"mtxgdn:spirit_grass", "灵草", "普通"},
            {"mtxgdn:iron_ore", "铁矿石", "普通"},
            {"mtxgdn:silver_ore", "银矿石", "普通"},
            {"mtxgdn:gold_ore", "金矿石", "稀有"},
            {"mtxgdn:mythril_ore", "秘银矿石", "稀有"},
            {"mtxgdn:beast_core", "兽核", "普通"},
            {"mtxgdn:demon_core", "魔核", "稀有"},
            {"mtxgdn:dragon_blood_crystal", "龙血晶", "史诗"},
            {"mtxgdn:ice_crystal", "冰晶", "稀有"},
            {"mtxgdn:heaven_fire_stone", "天火石", "史诗"},
            {"mtxgdn:star_sand", "星辰沙", "稀有"},
            {"mtxgdn:spirit_pearl", "灵珠", "史诗"},
            {"mtxgdn:thousand_year_heshouwu", "千年何首乌", "稀有"},
            {"mtxgdn:deep_sea_coral", "深海珊瑚", "史诗"},
            {"mtxgdn:ghost_fire_essence", "鬼火精华", "稀有"},
            {"mtxgdn:sky_silk", "天蚕丝", "史诗"},
            {"mtxgdn:blood_jade_marrow", "血玉髓", "史诗"},
        };
