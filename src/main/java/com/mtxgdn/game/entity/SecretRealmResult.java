...
public class SecretRealmResult {
    ...
    private long nextSecretRealmTime;

    public SecretRealmResult() {
    }

    public static SecretRealmResult failure(String message) {
        SecretRealmResult r = new SecretRealmResult();
        r.success = false;
        r.message = message;
        return r;
    }
    ...
    public long getNextSecretRealmTime() {
        return nextSecretRealmTime;
    }

    public void setNextSecretRealmTime(long nextSecretRealmTime) {
        this.nextSecretRealmTime = nextSecretRealmTime;
    }
}
