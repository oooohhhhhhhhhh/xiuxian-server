...
public class CraftingService {
    ...
    public void insertDefaultRecipes() {
        ...
        Object[][] defaults = {
            ...
            {"锻造灵剑", "以铁矿石为主材，融入灵石锻造的灵剑", "EQUIPMENT", 1, "mtxgdn:spirit_sword", 1, "mtxgdn:iron_ore", 5, "mtxgdn:spirit_stone", 3, null, 0, 400L, 100L, 0.75, 50L, 120L, 0.05, 0.01, 0.2},
            ...
            {"锻造龙剑", "以龙鳞为主材锻造的神兵", "EQUIPMENT", 4, "mtxgdn:dragon_sword", 1, "mtxgdn:dragon_scale", 5, "mtxgdn:heaven_fire_stone", 3, "mtxgdn:spirit_stone", 5, 20000L, 5000L, 0.40, 200L, 500L, 0.03, 0.005, 0.4},
            ...
            {"炼制星辰法袍", "以星砂编织的法袍", "EQUIPMENT", 3, "mtxgdn:star_robes", 1, "mtxgdn:star_sand", 5, "mtxgdn:spirit_wood", 3, "mtxgdn:spirit_stone", 5, 10000L, 2000L, 0.50, 100L, 300L, 0.04, 0.01, 0.3},
            {"炼制聚灵石", "浓缩灵石精华而成，蕴含大量灵石能量", "CONSUMABLE", 1, "mtxgdn:spirit_stone_pouch", 1, "mtxgdn:spirit_stone", 5, "mtxgdn:iron_ore", 3, null, 0, 100L, 0L, 0.90, 10L, 40L, 0.03, 0.005, 0.1},
